...
export const metadata: Metadata = {
  title: "The Grazer · The Farming Company",
  description:
    "The Grazer — an autonomous segmented soil robot that pulls weeds mechanically, aerates and feeds the soil, and streams live readings from every plant and every acre.",
};
...
export default function GrazerPage() {
  return (
    <main className="bg-char">
      ...
      <section className="relative flex min-h-screen flex-col justify-end overflow-hidden px-6 pb-16 pt-28 lg:px-10 lg:pb-24">
        ...
        <div className="relative mx-auto w-full max-w-7xl">
          ...
          <div className="mt-10">
            <span className="eyebrow">Grazer G-04</span>
          </div>
      ...
      <section className="border-t hairline py-20 text-center lg:py-28">
        <div className="mx-auto max-w-3xl px-6">
          <h2 className="display text-paper text-4xl leading-[0.95] sm:text-5xl lg:text-6xl">
            Put the Grazer to work on your land.
          </h2>
          <a
            href="/#contact"
            className="group mt-8 inline-flex items-center gap-2 text-[15px] text-paper transition-colors hover:text-fog"
          >
            Talk to us
            <span className="transition-transform duration-300 group-hover:translate-x-1">→</span>
          </a>
